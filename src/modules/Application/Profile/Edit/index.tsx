...
import { ChangePasswordValues, UserValues } from '../../../../typings/userTypings';
    ...
    const handleSubmit = async (values: UserValues) => {
        ...
        try {
            ...
            dispatch(actions.auth.loginUser({
                ...
                lastEducationDegree: response.data.user.last_education_degree,
                lastEducationInstitute: response.data.user.last_education_institute,
